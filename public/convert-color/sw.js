...
const CACHE_NAME = 'convert-color-v1';
const RUNTIME_CACHE = 'convert-color-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/convert-color/',
  '/convert-color/manifest.json',
  '/convert-color/icon-192.png',
  '/convert-color/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/convert-color/manifest.json';
}
